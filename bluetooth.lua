...
return {
    ...
    common = {
        ...
        active_profile = "xbox_wireless_controller", -- 当前活动的配置文件 ID
    },
    ...
    profiles = {
        ...
        ["xbox_wireless_controller"] = {
            ...
            -- 按键映射: 正数=下一页, 负数=上一页
            key_map = {
                [304] = 1, [307] = 1, [310] = 1,   -- 下一页按键
                [305] = -1, [308] = -1, [311] = -1, -- 上一页按键
            },

            -- D-Pad 模式映射 (codes: 16=X轴, 17=Y轴, values: -1/0/1)
            dpad_map = {
                [17] = { [1] = 1, [-1] = -1 },     -- Y轴: 下=下一页, 上=上一页
                [16] = { [-1] = 1, [1] = -1 }      -- X轴: 左=下一页, 右=上一页
            },

            -- 模拟摇杆映射 (codes: 0=X轴, 1=Y轴)
            analog_map = {
                [1] = { axis = "Y", low_dir = -1, high_dir = 1 },  -- Y轴: 上=上一页, 下=下一页
                [0] = { axis = "X", low_dir = 1, high_dir = -1 }   -- X轴: 左=下一页, 右=上一页
            },
        },
